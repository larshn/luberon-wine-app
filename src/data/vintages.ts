...
export const vintageRatings: VintageRating[] = [
  ...
  { year: 2000, rating: 3, description: 'Middels (regn i september)' },
  ...
  { year: 2008, rating: 3, description: 'Middels' },
  { year: 2009, rating: 4, description: 'Utmerket' },
  { year: 2010, rating: 5, description: 'Eksepsjonelt' },
  { year: 2011, rating: 3, description: 'Middels' },
  { year: 2012, rating: 3, description: 'Middels' },
  ...
  { year: 2022, rating: 4, description: 'Lovende (preliminær)' },
  { year: 2023, rating: 3, description: 'God (preliminær)' },
  { year: 2024, rating: 3, description: 'Lovende, lav volum (preliminær)' },
];
